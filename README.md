...
<head>
    ...
    <title>冰威茶话会 - 铭记731历史 勿忘国耻</title>
...
<body class="font-sans text-light overflow-x-hidden bg-primary">
    ...
    <!-- 音乐控制按钮 - 固定在右上角 -->
    <div class="fixed top-4 right-4 z-50 bg-glass p-3 rounded-full shadow-lg border border-white/20">
    ...
    <!-- 音乐加载状态提示 -->
    <div id="music-status" class="fixed top-4 left-4 z-50 bg-glass px-4 py-2 rounded-lg shadow-lg border border-white/20 text-sm hidden">
    ...
    <div class="relative h-screen preserve-3d overflow-hidden">
            ...
            <div class="h-full flex flex-col justify-between px-4 z-10 relative">
                    ...
                    <div class="max-w-3xl mx-auto mb-12 animate-slide-up" style="animation-delay: 0.8s">
                        <div class="relative pl-10 ml-6 space-y-8">
                            <div class="history-timeline-item relative">
                                ...
                                <p class="text-gray-300 text-sm md:text-base">731部队在哈尔滨平房区正式建立，开始秘密进行细菌武器研究</p>
                            </div>
                            <div class="history-timeline-item relative">
                                <h3 class="text-lg md:text-xl font-bold text-accent mb-2">1937-1945年</h3>
                                <p class="text-gray-300 text-sm md:text-base">对数千名无辜平民和战俘进行残酷的人体实验，犯下反人类罪行</p>
                            </div>
                            <div class="history-timeline-item relative">
                                <h3 class="text-lg md:text-xl font-bold text-accent mb-2">至今</h3>
                                <p class="text-gray-300 text-sm md:text-base">历史真相不应被遗忘，我们铭记苦难，只为守护和平</p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="pb-16 text-center animate-bounce">
                    <button id="next-to-page-2" class="text-white/80 hover:text-white transition-colors duration-300 flex flex-col items-center mx-auto">
                        <span class="mb-2 text-sm md:text-base">了解更多历史真相</span>
        ...
        <div id="page-2" class="absolute inset-0 page-transition transform-gpu translate-x-full">
            <div class="h-full flex flex-col">
                ...
                <div class="p-4 md:p-6 bg-glass border-b border-white/10">
                    <h2 class="text-[clamp(1.3rem,3vw,2rem)] font-display font-bold">历史真相</h2>
                </div>
                    ...
                    <div class="max-w-6xl mx-auto space-y-10 md:space-y-16">
                        ...
                        <div class="animate-slide-up">
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-10 items-center">
                                <div>
                                    <h3 class="text-xl md:text-2xl font-bold mb-4 text-accent">731部队的建立与罪行</h3>
                                    <p class="text-gray-300 mb-3 leading-relaxed text-sm md:text-base">
                                        731部队是日本军国主义在第二次世界大战期间，在中国东北建立的一支秘密细菌战部队，全称为"关东军防疫给水部"。
                                    </p>
                                    <p class="text-gray-300 mb-3 leading-relaxed text-sm md:text-base">
                                        这支部队成立于1935年，总部设在哈尔滨平房区，占地约6平方公里，拥有3000多名工作人员，是当时世界上规模最大的生物武器研究、开发和生产基地。
                                    </p>
                                    <p class="text-gray-300 leading-relaxed text-sm md:text-base">
                                        他们以"防疫研究"为幌子，实则对活人进行极其残忍的生物武器和化学武器实验，犯下了反人类的滔天罪行。
                                    </p>
                                </div>
                        ...
                        <div class="animate-slide-up" style="animation-delay: 0.2s">
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-2 md:gap-10 items-center md:flex-row-reverse">
                                <div>
                                    <h3 class="text-xl md:text-2xl font-bold mb-4 text-accent">"马路大"的悲惨命运</h3>
                                    <p class="text-gray-300 mb-3 leading-relaxed text-sm md:text-base">
                                        731部队将实验对象称为"马路大"（日语"原木"之意），这些受害者主要是中国平民、战俘，还包括朝鲜人、苏联人等。
                                    </p>
                                    <p class="text-gray-300 mb-3 leading-relaxed text-sm md:text-base">
                                        他们被当作实验材料，遭受了活体解剖、细菌感染、冻伤实验、毒气实验、火焰喷射器实验等非人折磨。
                                    </p>
                                    <p class="text-gray-300 leading-relaxed text-sm md:text-base">
                                        据史料记载，至少有3000名无辜者在这些实验中被杀害，而实际数字可能更高，许多受害者甚至没有留下任何记录。
                                    </p>
                                </div>
                                <div class="relative rounded-xl overflow-hidden shadow-2xl transform transition-all duration-700 hover:scale-[1.02]">
                        ...
                        <div class="animate-slide-up" style="animation-delay: 0.4s">
                            <h3 class="text-xl md:text-2xl font-bold mb-6 text-accent text-center">铁证如山的历史事实</h3>
                            <div class="grid grid-cols-1 gap-6 md:grid-cols-3 md:gap-8">
                                <div class="bg-glass p-5 rounded-xl border border-white/10 shadow-lg hover:shadow-2xl transition-all duration-500">
                                    ...
                                    <p class="text-gray-300 text-center text-xs md:text-sm">
                                        哈尔滨平房区的731部队遗址保存了大量实验室、监狱、焚尸炉等设施遗迹，是其罪行的直接见证。
                                    </p>
                                </div>
                                ...
                                <div class="bg-glass p-5 rounded-xl border border-white/10 shadow-lg hover:shadow-2xl transition-all duration-500">
                                    ...
                                    <p class="text-gray-300 text-center text-xs md:text-sm">
                                        大量部队成员的日记、实验报告和战后供词，详细记录了各种残忍实验的过程和结果。
                                    </p>
                                </div>
                                ...
                                <div class="bg-glass p-5 rounded-xl border border-white/10 shadow-lg hover:shadow-2xl transition-all duration-500">
                                    ...
                                    <h4 class="text-base md:text-xl font-bold mb-3 text-center">幸存者证词</h4>
                                    <p class="text-gray-300 text-center text-xs md:text-sm">
                                        少数逃脱的受害者和附近居民的证词，生动描述了731部队的暴行和受害者的悲惨遭遇。
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div id="page-3" class="absolute inset-0 page-transition transform-gpu translate-x-full">
            <div class="h-full flex flex-col">
                <!-- 页头 -->
                <div class="p-4 md:p-6 bg-glass border-b border-white/10">
                    <h2 class="text-[clamp(1.3rem,3vw,2rem)] font-display font-bold">默哀致敬</h2>
                </div>
                ...
                <div class="flex-1 overflow-y-auto p-4 md:p-6">
                    <div class="max-w-4xl mx-auto text-center space-y-10 md:space-y-16">
                        <!-- 默哀区 -->
                        <div class="animate-slide-up">
                            <h3 class="text-xl md:text-2xl font-bold mb-8">为遇难同胞默哀</h3>
                        ...
                        <div class="animate-slide-up" style="animation-delay: 0.3s">
                            <h3 class="text-xl md:text-2xl font-bold mb-8">遇难者纪念</h3>
                            ...
                            <div class="relative rounded-xl overflow-hidden shadow-2xl mb-6">
                                ...
                                <div class="absolute bottom-6 left-0 right-0 text-center">
                                    <p class="text-xl text-white text-shadow">我们永远不会忘记你们</p>
                                </div>
                            </div>

                            <p class="text-gray-300 max-w-2xl mx-auto leading-relaxed text-sm md:text-base">
                                每一个无辜逝去的生命都值得被铭记。他们的苦难是人类历史上的一道伤疤，提醒我们战争的残酷和人性的脆弱。
                                让我们永远记住这段历史，为了那些不能再开口的受害者，为了防止悲剧重演。
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div id="page-4" class="absolute inset-0 page-transition transform-gpu translate-x-full">
            <div class="h-full flex flex-col">
                <!-- 页头 -->
                <div class="p-4 md:p-6 bg-glass border-b border-white/10">
                    <h2 class="text-[clamp(1.3rem,3vw,2rem)] font-display font-bold">反思与前行</h2>
                </div>
                    ...
                    <div class="max-w-6xl mx-auto space-y-10 md:space-y-16">
                            ...
                            <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                                <div>
                                    <p class="text-gray-300 mb-4 leading-relaxed text-sm md:text-base">
                                        我们铭记731部队的罪行，不是为了延续仇恨，而是为了以史为鉴，警惕战争的悲剧重演，珍惜当下的和平。
                                    </p>
                                    <p class="text-gray-300 mb-4 leading-relaxed text-sm md:text-base">
                                        这段历史告诉我们，当科学失去伦理的约束，当人权被肆意践踏，当军国主义和法西斯主义抬头，人类将面临何等可怕的灾难。
                                    </p>
                                    <p class="text-gray-300 leading-relaxed text-sm md:text-base">
                        ...
                        <div class="animate-slide-up" style="animation-delay: 0.6s">
                            <div class="bg-glass p-6 md:p-10 rounded-xl border border-white/10 shadow-xl">
                                <h3 class="text-xl md:text-2xl font-bold mb-6 text-center">吾辈当自强</h3>
                        ...
                        <div class="animate-slide-up" style="animation-delay: 0.9s">
                            <h3 class="text-xl md:text-2xl font-bold mb-8 text-accent text-center">纪念留言</h3>
                            ...
                            <div class="max-w-4xl mx-auto">
                                <form id="message-form" class="mb-10 bg-glass p-6 rounded-xl shadow-lg border border-white/10">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea id="message" rows="4" class="w-full px-4 py-2 bg-white/5 border border-white/20 rounded-lg focus:outline-none focus:ring-2 focus:ring-accent focus:border-transparent transition-all duration-300 text-sm" placeholder="请留下您的心声..." required></textarea>
                                    </div>
                                ...
                                <div id="messages-container" class="space-y-4">
                                    ...
                                    <div class="bg-glass p-5 rounded-xl shadow-lg border border-white/10 transform transition-all duration-500 hover:shadow-xl hover:border-white/20">
                                        <div class="flex justify-between items-start mb-3">
                                            <h4 class="font-bold text-white text-base">冰威茶话会成员</h4>
    ...
    <script>
        ...
        function setupMusicControl() {
            ...
            music.addEventListener('loadedmetadata', function() {
                isLoading = false;
                showMusicStatus('默哀音乐加载完成，点击播放', 3000);
            });
            ...
            musicControl.addEventListener('click', function() {
                if (isPlaying) {
                    ...
                    music.play().then(() => {
                        ...
                        // 显示更详细的错误提示
                        setTimeout(() => {
                            alert('音乐播放失败，可能是由于浏览器安全限制。您可以尝试：\n1. 点击地址栏左侧的小图标\n2. 选择"网站设置"\n3. 允许"声音"权限');
                        }, 1000);
                    });
                }
            });
            ...
            setTimeout(() => {
                if (!isPlaying && !isLoading) {
                    showMusicStatus('点击右上角播放默哀音乐', 5000);
                }
            }, 3000);
        }
